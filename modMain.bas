...
' ***************************************************************************
  ...
  Public Const PGM_NAME              As String = "kiMisc DLL Demo"
...
'
'                    1.  Deactivate and free from memory
'                        all global objects or classes
...
Public Function FindRequiredFile(ByVal strFilename As String, _
    ...
    Else
        ...
        strSearched = strPath & vbNewLine   ' Save application path to searched list
